                ...
                <div className="wrapper">
                    ...
                    <div className="about__content">
                        <div className="about__information">
                            ...
                            <p>
                                Being a self-taught software programmer has presented its difficulties.
                                Learning as much as I can through videos, docs, and repositories.
                            </p>
                        ...
                        <div className="profile__picture" style={{ backgroundImage: 'url(/images/information/photo.jpg)'}}></div>
                    </div>
                </div>
            </div>
        </>
